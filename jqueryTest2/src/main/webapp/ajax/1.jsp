...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#b2').click(function(){
			// load('url',핸들러:비동기요청 응답오면 자동 호출될 함수)
			$('#d2').load('server2.jsp', function(res, stat, xhr){ // res: 서버로부터 받은 값, stat: 상태, xhr: 비동기 객체
				if(stat == 'success'){
		...
		$('#b3').click(function(){
			...
			// load('url', 서버로 전송할 데이터, 핸들러: 비동기요청 응답오면 자동 호출될 함수)
